          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                // Responsive album artwork container
                Container(
                  width: size.width * 0.7, // 70% of screen width
                  height: size.width * 0.7, // Keep the aspect ratio
                  decoration: BoxDecoration(
                    color: Colors.white.withOpacity(0.2),
                    borderRadius: BorderRadius.circular(50),
                  ),
                    ...
                    child: SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Consumer<SongImageProvider>(
                          builder: (context, songImageProvider, child) {
                            return Hero(
                              tag: songImageProvider
                                  .id, // Use the song ID as the tag
                              child: QueryArtworkWidget(
                                id: songImageProvider.id,
                                type: ArtworkType.AUDIO,
                                nullArtworkWidget:
                                    const Icon(Icons.music_note, size: 100),
                                artworkFit: BoxFit.cover,
                                keepOldArtwork:
                                    true, // Keep the previous artwork to avoid flicker
                              ),
                            );
                          },
                        ),
                ...
                Text(
                  ...
                  style: GoogleFonts.nunito(
                    textStyle: TextStyle(
                      color: Colors.white,
                      fontSize:
                          size.width * 0.06, // Adjust text size based on width
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                ),
                ...
                Text(
                  ...
                  style: GoogleFonts.nunito(
                    textStyle: TextStyle(
                      color: Colors.white54,
                      fontSize:
                          size.width * 0.04, // Adjust text size based on width
                    ),
                  ),
                ),
                    ...
                    IconButton(
                      icon: Icon(
                        _isPlaying
                            ...
                            : Icons.play_circle_filled,
                        color: Colors.blueAccent,
                        size: size.width * 0.15, // 15% of screen width for size
                      ),
                      onPressed: () {
                        if (_isPlaying) {
                          widget.audioPlayer.pause();
