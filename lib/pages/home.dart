...
import 'package:google_fonts/google_fonts.dart';
import 'package:just_audio/just_audio.dart';
import 'package:music/functions/find_genre.dart';
import 'package:music/pages/camera.dart';
import 'package:music/pages/musicscreen.dart';
import 'package:music/pages/search_page.dart';
...
class _MyMusicAppState extends State<HomeScreen> {
  ...
  IconData getGreetingIcon() {
    ...
    if (hour < 12) {
      return Icons.wb_sunny; // Morning sun icon
    } else if (hour < 17) {
      return Icons.wb_cloudy; // Afternoon cloudy icon
    } else {
      return Icons.nights_stay; // Evening night icon
    }
  }
